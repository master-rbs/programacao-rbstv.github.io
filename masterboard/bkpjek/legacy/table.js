...
<tr>\
  <!-- CREST ICON -->\
  <th class="crest">\
    <img class="crestpic" title="Este Mitador ainda não possui Crest própria" src="assets/none.png">\
  </th>\
  <!-- NAME -->\
  ...
  <th align="right" class="tiericon"><img class="tier" title="Mitador Unicorn: Raros porém participativos" src="assets/uni.png"></th>\
</tr>\
<tr>\
  <!-- PROFILE PIC -->\
...
/*
for (var i in myth){
document.write(createTable(_database/myth[i],'B',mit[i][1],'D'));
}
