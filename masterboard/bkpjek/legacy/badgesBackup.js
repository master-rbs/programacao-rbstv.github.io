...
Badges._database/mythMinister = {
    titulo: '_database/mythnister: Leading the path of strife!',
    img: 'minister',
    nome: '_database/mythnister',
    tipo: 'Tier',
