...
Badgelist._database/mythMinister = createBadge('_database/mythnister: Leading the path of strife!', 'minister','_database/mythnister','Tier',
...
Badgelist._database/mythDiamond = createBadge('Mitador Diamond: Amor à camisa', 'diamond','Mitador Diamond','Tier',
'Badge reservada a Mitadores de Tier Diamond.<br> Participam além do social. (Reserved) ');
 	 Badgelist._database/mythUnicorn = createBadge('Mitador Unicorn: Raros porém participativos', 'uni','Mitador Unicorn','Tier',
'Badge reservada a Mitadores de Tier Unicorn.<br> Aparecem raramente mas são muito participativos. (Reserved) ');
     Badgelist._database/mythPlatinum = createBadge('Mitador Platinum', 'plat','Mitador PLATINUM','Tier',
'Badge reservada a Mitadores de Tier Platinum.<br> São sempre os mais ativos, e estão sempre contribuíndo promovendo conteúdo e interação. (Reserved) ');
     Badgelist._database/mythSilver = createBadge('Mitador Silver', 'silver','Mitador SILVER','Tier',
'Badge reservada a Mitadores de Tier Silver.<br> São os com atividade regular no grupo. (Reserved) ');
     Badgelist._database/mythLegacy = createBadge('Mitador Legacy: Veterano dos primórdios!', 'legacy','Mitador Legacy','Tier',
'Badge reservada a Mitadores com privilégios Legacy.<br> São os mais antigos e responsáveis pelo grupo se tornar um grupo. (Unobtainable) ');
     Badgelist._database/mythFresh = createBadge('Freshman: Mitadores Trainee', 'fresh','Academy Freshman','Tier',
'Badge reservada a Mitadores de Tier Freshman.<br> Tem menos de um mês de casa. (Reserved) ');
     Badgelist._database/mythGuest = createBadge('Guest: Não-mitador que convive na casa.', 'guest','Convidado','Tier',
'Badge reservada a Mitadores de Tier Guest.<br> Não são exatamente Mitadores, mas estão dentro presenciando o cotidiano dos mitos. (Reserved) ');
     Badgelist._database/mythHonorary = createBadge('Mitador Honorary: Protegido pessoal de um Prime ou Platinum', 'honor','Mitador Honorário','Tier',
'Badge reservada a Mitadores com privilégios Honorary.<br> Os "protegidos", Mitadores que não podem ser banidos por inatividade. (Reserved) ');
     Badgelist._database/mythLurker = createBadge('Lurker: Sempre nas sombras, eventualmente se pronuncia.', 'lurk','Lurker','Tier',
'Badge reservada a Mitadores de Tier Lurker.<br> Raramente aparecem, apenas observam, costumam mitar mais durante encontros. (Reserved) ');
     Badgelist._database/mythGold = createBadge('Mitador Gold', 'gold','Mitador GOLD','Tier',
'Badge reservada a Mitadores de Tier Gold.<br> São os mais ativos no chat, e bastante ativos no grupo, e eventos, e tudo mais.. (Reserved) ');
     Badgelist._database/mythGhost = createBadge('Mitador Ghost: Inativo há mais de um mês.', 'ghost', 'Mitador Fantasma','Tier',
'Badge reservada a Mitadores de Tier Ghost.<br> Mitadores Fantasmas, aparecem, dão um oi, e somem por meses, geralmente interagem mais pessoalmente. (Reserved) ');
     Badgelist._database/mythPrime = createBadge('Mitador Prime: Os primeiros Mitadores, criadores da porra toda.', 'prime','Mitador Prime','Tier',
...
' Exclusiva do Arthur por ser um baita Pipoqueiro de Tretas (Unobtainable)');
     Badgelist.encontro_myth = createBadge('Encontro Mitador: eu fui!', 'group','Encontro Mitador','Evento',
...
'Vença um torneio de Skullgirls');
     Badgelist._database/mythEvent = createBadge('Mitador de Evento',undefined,'Mitador de Evento','Entrada','Mitadores que entraram por meio de sobrevivência a Eventos que envolve gente de fora(Unobtainable)',
...
function index_database/myth(mitabela){
