...
//Tier
    ...
    var mythMinister = createBadge('_database/mythnister: Leading the path of strife!', 'minister');
...
<tr>\
  ...
  <td class="tg-031e"></td>\
  <td class="since" align="right"  colspan="3" >Mitando since  <strong class="_database/mythano">' + mito.ano + '</strong></td>\
</tr>\
<tr>\
  <!-- BADGES -->\
